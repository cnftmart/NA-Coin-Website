...
const Presale: React.FC = () => {
    ...
    return (
        <>
            <div className=" flex flex-col w-full items-center mt-[6em] mb-[8em]">
                ...
                <div className=" mobil | flex-col mt-[5em] items-center">
                    <div className=" w-[20em] mb-[0.5em]">
                        {batch_1.map((item) => (
                        <React.Fragment key={item.id}>
                            ...
                            <div onClick={() => handleOpen(item.id * 0)}>
                                <ul aria-busy={true}>
                                <div className=" flex flex-col mr-[10em] leading-8 ml-[51.2px]">
                    ...
                    <div className=" w-[15em] mb-[0.5em]">
                        ...
                        <React.Fragment key={item.id}>
                            ...
                            <div onClick={() => handleOpen(item.id * 0)}>
                                <ul aria-busy={true}>
                                <div className=" flex flex-col w-full mr-[10em] leading-8 ml-[51.2px]">
                                    <li className=" font-light text-[0.9em]">{item.date}</li>
                                    <li className=" text-[0.625em] font-bold">{item.description}</li>
                                </div>
                                </ul>
                    ...
                    <div className=" w-[15em] ">
                        {batch_1.map((item) => (
                            <>
                                ...
                                <div>
                                    <ul aria-busy={true}>
                                    <div className=" flex flex-col w-full mr-[10em] leading-8 ml-[54.4px]">
                                        <li className=" font-light text-[1.125em]">{item.date}</li>
                                        <li className=" text-[0.625em] font-extrabold">{item.description}</li>
                                    </div>
                                    </ul>
                                </div>
                            </>
